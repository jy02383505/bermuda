...
with open('/Application/bermuda/conf/rsa/bermuda_pub.pem', 'r') as bermuda_pub:
    bermuda_pub_key = bermuda_pub.read()
if bermuda_pub_key is None:
    raise

bermuda_pri_key = None
with open('/Application/bermuda/conf/rsa/bermuda_pri.pem', 'r') as bermuda_pri:
    bermuda_pri_key = bermuda_pri.read()
if bermuda_pri_key is None:
    raise

cache_pub_key = None
with open('/Application/bermuda/conf/rsa/cache_pub.pem', 'r') as cache_pub:
    cache_pub_key = cache_pub.read()
if cache_pub_key is None:
    raise

portal_pub_key = None
with open('/Application/bermuda/conf/rsa/portal_pub.pem', 'r') as portal_pub:
