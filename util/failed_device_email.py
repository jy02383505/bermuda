...
LOG_FILENAME = '/Application/bermuda/logs/failed_device_email.log'
...
def make_content(failed_devices):
    ...
    sorted_info = sorted(failed_devices.items(),key=lambda x:x[1],reverse=True)
