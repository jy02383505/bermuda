...
class ParseHeader():
    ...
    def get_code(self):
        ...
        try:
            ...
            logger.debug('get http header first line error:%s' % traceback.format_exc(e))
            return 0
        ...
        try:
            ...
            logger.debug('get http header code error:%s' % traceback.format_exc(e))
            return 0
    ...
    def refresh_result(self):
        ...
        try:
            ...
            logger.debug('get refresh_result error:%s' % traceback.format_exc(e))
            return 'error'
    ...
    def judge_value(self, str1, dict_str):
        ...
        try:
            ...
            logger.debug('judge error:%s' % traceback.format_exc(e))
            return False
