...
# def get_preload_urls(username='zyhq', offset_start=60 * 35, offset_end=60 * 30):
    ...
    return preload_urls
    # except Exception, e:
    #     print "status_progress2finished get_preload_urls:%s" % traceback.format_exc(e)
    #     return
...
def is_dispatch_success(preload_url, onlyFirst=True):
    ...
    print '\n-----preload_dev-----\n', preload_dev
    # exit()
    for dev in preload_dev['devices'].values():
        # dev_list.add(dev)
        dev_count += 1
    ...
    #     print "status_progress2finished is_dispatch_success:%s" % traceback.format_exc(e)
    #     return False
...
def is_report_success(preload_url):
    ...
    return False
    # except Exception as e:
    #     print "status_progress2finished is_report_success:%s" % traceback.format_exc(e)
    #     return False
