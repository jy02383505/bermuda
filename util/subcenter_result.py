...
LOG_FILENAME = '/Application/bermuda/logs/subcenter_result.log'
...
def get_subcenter_data_from_remote(str):
    ...
    :return:
    """
    conn = httplib.HTTPConnection(str)
...
def parse_data_update_mongo(data_info, data_mongo):
    ...
    if email_dict:
        #assemble_mail_content_send(email_dict)#close subcent email #201812
        pass

    if data_info:
        try:
            db.sub_regis_info.insert_many(data_info.values())
