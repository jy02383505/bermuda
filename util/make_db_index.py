...
db.preload_url.create_indexes([eval("preload_url_index%s" %i) for i in xrange(1,8)])
...
db.ref_err.create_indexes([eval("ref_err_index%s" %i) for i in xrange(1,6)])
...
db.request.create_indexes([eval("request_index%s" %i) for i in xrange(1,5)])
...
db.url.create_indexes([eval("url_index%s" %i) for i in xrange(1,11)])
print 'url ok'
