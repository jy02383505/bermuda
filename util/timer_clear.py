...
LOG_FILENAME = '/Application/bermuda/logs/clean_db.log'
    ...
    for i in range(24):
        ...
        if device_count > 0:
            try:
                ...
                logger.debug("device error :%s" % ex)
        ...
        if request_count > 0:
            try:
                ...
                logger.debug("request error :%s" % ex)
        ...
        if request_count > 0:
            try:
                ...
                logger.debug("preload_url error :%s" % ex)
    ...
    for i in range(24):
        ...
        if error_task_count > 0:
            try:
                ...
                logger.debug("error_task error :%s" % ex)
    ...
    for i in range(24):
        ...
        if preload_error_task_count > 0:
            try:
                ...
                logger.debug("preload_error_task error :%s" % ex)
