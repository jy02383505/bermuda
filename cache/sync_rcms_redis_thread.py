        ...
        try:
            for username in self.userlist:
                ...
                for channel_obj in channels:
                    ...
                    if channel_obj.get('channelState') not in ["TRANSFER", "CUSPAUSE", "SYSPAUSE"]:
            ...
            logger.error('SyncObjThread thread run exception:---%r,%r' % (self.thread_name,traceback.format_exc(e)))
            raise e
