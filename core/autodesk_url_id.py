...
def update_url_autodesk(id):
    ...
    try:
        ...
        logger.debug("check_url_autodesk update_url_autodesk error, id:%s, %s" % (id, traceback.format_exc(e)))
        return
...
def failed_task_email(id, username, created_time):
    ...
    try:
        ...
        logger.debug('failed_task_email parse_data error:%s' % traceback.format_exc(e))
