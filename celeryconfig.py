...
CELERY_IMPORTS = ("core.splitter","core.splitter_new","core.splitter_refreshDevice","core.url_refresh","core.dir_refresh","core.preload_worker","core.preload_worker_new","core.cert_trans_worker","core.cert_query_worker","core.transfer_cert_worker",
				  ...
				  "receiver.receiver_branch", "core.link_detection_all",
				  "core.splitter_autodesk", "core.autodesk_url_id", "core.preload_webluker","core.physical_refresh","core.verify",
				  "core.fail_task_refresh")

CELERY_ROUTES = { "core.url_refresh.work": {"queue": "refresh"},
	                "core.dir_refresh.work": {"queue": "dir_refresh"},
                    "core.url_refresh.high_work": {"queue": "high_refresh"},
	                "core.dir_refresh.high_work": {"queue": "high_dir_refresh"},
	                "core.preload_worker.dispatch": {"queue": "preload"},
	                "core.preload_worker_new.dispatch": {"queue": "preload_dispatch"},
	                ...
	                "core.preload_worker_new.save_fc_report": {"queue": "preload_report"},
				    ...
				    "core.verify.callback_celery":{"queue":"callback_refresh"},
				    "core.fail_task_refresh.send_device_open":{"queue":"fail_dev_refresh"},
				    "core.fail_task_refresh.send_fail_url_package":{"queue":"fail_url_package"},
				    "core.fail_task_refresh.send_fail_dir_package":{"queue":"fail_dir_package"}
